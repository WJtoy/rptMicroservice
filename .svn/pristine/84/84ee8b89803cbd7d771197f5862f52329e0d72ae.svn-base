...
public class CustomerFrozenDailyRptService  extends RptBaseService {
     ...
     * 获取客户每日下单列表
     */
    public Page<RPTCustomerFrozenDailyEntity> getCustomerFrozenDailyList(RPTSearchCondtion rptSearchCondtion) {
...
//            entity.setOrderItems(RPTOrderItemUtils.fromOrderItemsJson(entity.getOrderItemJson()));
     ...
     * 创建Excel表格
     */
    public SXSSFWorkbook exportCustomerFrozenDailyRpt(String searchConditionJson, String reportTitle) {
        ...
        try {
            ...
            log.error("客户每日冻结明细报表写入excel失败:{}", Exceptions.getStackTraceAsString(e));
            return null;
        }
        return xBook;
    }
