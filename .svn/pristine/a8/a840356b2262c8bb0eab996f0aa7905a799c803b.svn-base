...
@RestController
@RequestMapping("customer/rptExportTask")
public class CtRptExportTaskController {
    ...
    public MSResponse<String> checkRptExportTask(@RequestBody RPTExportTaskEntity taskEntity) {
        ...
        if (reportEnum != null && RPTUserTypeEnum.CUSTOMER.equals(reportEnum.userType) && taskEntity.getTaskCreateBy() != null) {
            try {
    ...
    public MSResponse<String> getRptExcelDownloadUrl(@RequestBody RPTExportTaskEntity taskEntity) {
        ...
        try {
            RPTReportEnum reportEnum = RPTReportEnum.valueOf(taskEntity.getReportId());
            if (reportEnum != null && RPTUserTypeEnum.CUSTOMER.equals(reportEnum.userType)) {
