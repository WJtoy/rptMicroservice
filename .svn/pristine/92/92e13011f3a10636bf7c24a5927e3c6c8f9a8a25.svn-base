...
import com.kkl.kklplus.provider.rpt.customer.service.CtCancelledOrderRptService;
import com.kkl.kklplus.provider.rpt.customer.service.CtCompletedOrderRptService;
import com.kkl.kklplus.provider.rpt.customer.service.CtCustomerChargeSummaryRptNewService;
import com.kkl.kklplus.provider.rpt.customer.service.CtCustomerWriteOffRptService;
...
@RestController
@RequestMapping("customer/customerCharge")
public class CtCustomerChargeRptController {
    ...
    public MSResponse<RPTCustomerChargeSummaryMonthlyEntity> getCustomerChargeSummaryMonthly(@RequestBody RPTCustomerChargeSearch search) {
        RPTCustomerChargeSummaryMonthlyEntity entity = ctCustomerChargeSummaryRptNewService.getCustomerChargeSummaryNew(search);
    ...
    public MSResponse<MSPage<RPTCompletedOrderEntity>> getCompletedOrderList(@RequestBody RPTCompletedOrderSearch search) {
        Page<RPTCompletedOrderEntity> pageList = ctCompletedOrderRptService.getCompletedOrderListByPaging(search);
    ...
    public MSResponse<MSPage<RPTCancelledOrderEntity>> getCancelledOrderList(@RequestBody RPTCancelledOrderSearch search) {
        Page<RPTCancelledOrderEntity> pageList = ctCancelledOrderRptService.getCancelledOrderListByPaging(search);
    ...
    public MSResponse<MSPage<RPTCustomerWriteOffEntity>> getCustomerWriteOffList(@RequestBody RPTCustomerWriteOffSearch search) {
        Page<RPTCustomerWriteOffEntity> pageList = ctCustomerWriteOffRptService.getCustomerWriteOffListByPaging(search);
