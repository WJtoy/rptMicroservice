...
public class RptServicePonintWriteService extends RptBaseService {
 ...
 */
   ...
   */
    ...
    public SXSSFWorkbook PointWriteOffExport(String searchConditionJson, String reportTitle) {
        ...
        xSheet.addMergedRegion(new CellRangeAddress(titleRow.getRowNum(), titleRow.getRowNum(), 0, 32));
        ...
        ExportExcel.createCell(headerFirstRow, 0, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "上月完工单未付（元）");
        ExportExcel.createCell(headerFirstRow, 1, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "本月完工单金额（元）");
        ExportExcel.createCell(headerFirstRow, 2, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "本月已付金额（元）");
        ExportExcel.createCell(headerFirstRow, 3, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "本月完工单未付（元）");
        ...
        ExportExcel.createCell(firstDataRow, 2, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, page.getPaidAmount());
        ExportExcel.createCell(firstDataRow, 3, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, page.getTheBalance());
        ...
        ExportExcel.createCell(headerSecondRow, 16, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "远程费");
        ExportExcel.createCell(headerSecondRow, 17, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "快递费");
        ExportExcel.createCell(headerSecondRow, 18, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "其他费");
        ExportExcel.createCell(headerSecondRow, 19, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "互助基金");
        ExportExcel.createCell(headerSecondRow, 20, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "时效奖励");
        ExportExcel.createCell(headerSecondRow, 21, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "厂商时效");
        ExportExcel.createCell(headerSecondRow, 22, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "加急费");
        ExportExcel.createCell(headerSecondRow, 23, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "扣点");
        ExportExcel.createCell(headerSecondRow, 24, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "平台费");
        ExportExcel.createCell(headerSecondRow, 25, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "质保金额");
        ExportExcel.createCell(headerSecondRow, 26, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "好评费");
        ExportExcel.createCell(headerSecondRow, 27, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "合计金额");
        ExportExcel.createCell(headerSecondRow, 28, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "状态");
        ExportExcel.createCell(headerSecondRow, 29, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "结算方式");
        ExportExcel.createCell(headerSecondRow, 30, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "付款日期");

        ExportExcel.createCell(headerSecondRow, 31, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "备注");
        xSheet.addMergedRegion(new CellRangeAddress(headerSecondRow.getRowNum(), headerSecondRow.getRowNum(), 31, 32));
        ...
        double engineerTaxFee = 0d;
        double engineerInfoFee = 0d;
        double engineerDeposit = 0d;
        ...
        do {
            ...
            if (list != null) {
                writeOffDataExport dataExport = new writeOffDataExport(xSheet, xStyle, rowIndex, servcieTimes, totalServiceCharge,totalMaterialCharge,
                        ...
                        totalActualCount, totalInCharge, rowNumber, list,engineerPraiseFee,engineerTaxFee,engineerInfoFee, engineerDeposit).invoke();
                ...
                engineerTaxFee = dataExport.getEngineerTaxFee();
                engineerInfoFee = dataExport.getEngineerInfoFee();
                engineerDeposit = dataExport.getEngineerDeposit();
        ...
        ExportExcel.createCell(dataRow, 16, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalTravelCharge);
        ExportExcel.createCell(dataRow, 17, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalExpressCharge);
        ExportExcel.createCell(dataRow, 18, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalOtherCharge);
        ExportExcel.createCell(dataRow, 19, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalEngineerInsuranceCharge);
        ExportExcel.createCell(dataRow, 20, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalEngineerCustomerTimelinessCharge);
        ExportExcel.createCell(dataRow, 21, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalEngineerTimelinessCharge);
        ExportExcel.createCell(dataRow, 22, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalEngineerUrgentCharge);
        ExportExcel.createCell(dataRow, 23, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, engineerTaxFee);
        ExportExcel.createCell(dataRow, 24, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, engineerInfoFee);
        ExportExcel.createCell(dataRow, 25, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, engineerDeposit);
        ExportExcel.createCell(dataRow, 26, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, engineerPraiseFee);
        ExportExcel.createCell(dataRow, 27, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalInCharge);
        ExportExcel.createCell(dataRow, 28, xStyle, ExportExcel.CELL_STYLE_NAME_HEADER, "");
        xSheet.addMergedRegion(new CellRangeAddress(dataRow.getRowNum(), dataRow.getRowNum(), 28, 32));

    } catch (Exception e) {
        log.error("【RptServicePonintWriteService.PointWriteOffExport】网点对账单明细报表写入excel失败, errorMsg: {}", Exceptions.getStackTraceAsString(e));
        return null;
    }
    return xBook;
}
...
private class writeOffDataExport {
    ...
    private double engineerTaxFee;
    private double engineerInfoFee;
    private double engineerDeposit;
    ...
    private writeOffDataExport(Sheet xSheet, Map<String, CellStyle> xStyle, int rowIndex, int servcieTimes, double totalServiceCharge,double totalMaterialCharge,
                               ...
                               int totalActualCount, double totalInCharge, int rowNumber, List<RPTServicePointOderEntity> list,double engineerPraiseFee,double engineerTaxFee, double engineerInfoFee, double engineerDeposit) {
        this.xSheet = xSheet;
        this.xStyle = xStyle;
        ...
        this.engineerDeposit = engineerDeposit;
    ...
    public double getEngineerDeposit() {
        return engineerDeposit;
    }
    ...
    private writeOffDataExport invoke() {
        for (RPTServicePointOderEntity item : list) {
            ...
            ExportExcel.createCell(dataRow, 16, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalTravel);
            ...
            ExportExcel.createCell(dataRow, 17, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalExpress);
            ...
            ExportExcel.createCell(dataRow, 18, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalOther);
            totalOtherCharge = totalOtherCharge + totalOther;

            double totalEngineerInsurance = item.getEngineerInsuranceCharge();
            ExportExcel.createCell(dataRow, 19, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalEngineerInsurance);
            ...
            ExportExcel.createCell(dataRow, 20, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, (item.getEngineerCustomerTimelinessCharge()));
            ...
            ExportExcel.createCell(dataRow, 21, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, (item.getEngineerTimelinessCharge()));
            ...
            ExportExcel.createCell(dataRow, 22, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, (item.getEngineerUrgentCharge()));
            totalEngineerUrgentCharge = totalEngineerUrgentCharge + totalEngineerUrgent;

            double totalTaxFee = item.getEngineerTaxFee();
            ExportExcel.createCell(dataRow, 23, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, (item.getEngineerTaxFee()));
            engineerTaxFee = engineerTaxFee +totalTaxFee ;

            double totalInfoFee = item.getEngineerInfoFee();
            ExportExcel.createCell(dataRow, 24, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, (item.getEngineerInfoFee()));
            engineerInfoFee = engineerInfoFee + totalInfoFee;

            double totalEngineerDeposit = item.getEngineerDeposit();
            ExportExcel.createCell(dataRow, 25, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, (item.getEngineerDeposit()));
            engineerDeposit = engineerDeposit + totalEngineerDeposit;

            double totalPraise = item.getEngineerPraiseFee();
            ExportExcel.createCell(dataRow, 26, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, (item.getEngineerPraiseFee()));
            ...
            double totalCharge = totalEngineerInsurance + totalEngineerCustomerTimeliness + totalEngineerTimeliness + totalEngineerUrgent+
                    totalMaterial+totalTravel+totalExpress+totalOther+totalSevcie+totalTaxFee+totalInfoFee + totalEngineerDeposit+totalPraise ;
            ExportExcel.createCell(dataRow, 27, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, totalCharge);
            totalInCharge = totalInCharge + totalCharge;

            ExportExcel.createCell(dataRow, 28, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, (item.getStatus().getLabel()));
            ...
            ExportExcel.createCell(dataRow, 31, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, (detail == null ? "" : detail.getRemarks()));
            ...
            if (rowSpan > 0) {
                for (int index = 1; index <= rowSpan; index++) {
                    ...
                    ExportExcel.createCell(dataRow, 23, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, 0.0d);
                    ExportExcel.createCell(dataRow, 24, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, 0.0d);
                    ExportExcel.createCell(dataRow, 25, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, 0.0d);
                    ExportExcel.createCell(dataRow, 26, xStyle, ExportExcel.CELL_STYLE_NAME_DATA, 0.0d);
