...
@RestController
@RequestMapping("customerNewOrderMonthRpt")
public class CustomerNewOrderMonthRptController {
    @Autowired
    ...
    public MSResponse<MSPage<RPTCustomerNewOrderDailyRptEntity>> getCustomerNewOrderDailyList(@RequestBody RPTSearchCondtion rptSearchCondtion) {
        Page<RPTCustomerNewOrderDailyRptEntity> customerNewOrderDailyPage = customerOrderMonthRptService.getCustomerNewOrderMonthList(rptSearchCondtion);
