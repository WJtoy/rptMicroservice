...
public class CrushCoverageRptService  extends RptBaseService {
     ...
     * @return
     */
    public List<RPTCrushCoverageEntity> getCrushCoverAreasRptData(RPTGradedOrderSearch rptGradedOrderSearch) {
       ...
       List<Long> townAreaIds = MSAreaUtils.getCrushAreaMap(rptGradedOrderSearch.getProductCategoryIds());
    ...
    public SXSSFWorkbook crushCoverAreasRptExport(String searchConditionJson,String reportTitle) {

        SXSSFWorkbook xBook = null;
        try{
            RPTGradedOrderSearch searchCondition = redisGsonService.fromJson(searchConditionJson, RPTGradedOrderSearch.class);
            List<RPTCrushCoverageEntity> provinceRptEntityList = getCrushCoverAreasRptData(searchCondition);
            ...
            log.error("【CrushCoverageRptService.crushCoverAreasRptExport】突击区域报表导入excel失败, errorMsg: {}", Exceptions.getStackTraceAsString(e));
            return null;
        }
        return xBook;
    }
