...
import com.kkl.kklplus.provider.rpt.customer.service.CtCustomerOrderDailyRptService;
...
@RestController
@RequestMapping("customer/customerNewOrderDailyRpt")
public class CtCustomerNewOrderDailyRptController {
    @Autowired
    ...
    public MSResponse<MSPage<RPTCustomerNewOrderDailyRptEntity>> getCustomerNewOrderDailyList(@RequestBody RPTSearchCondtion rptSearchCondtion) {
        Page<RPTCustomerNewOrderDailyRptEntity> customerNewOrderDailyPage = ctCustomerOrderDailyRptService.getCustomerNewOrderDailyList(rptSearchCondtion);
