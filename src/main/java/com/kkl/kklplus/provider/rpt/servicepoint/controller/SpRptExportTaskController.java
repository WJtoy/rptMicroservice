...
@RestController
@RequestMapping("servicePoint/rptExportTask")
public class SpRptExportTaskController {
    ...
    public MSResponse<String> checkRptExportTask(@RequestBody RPTExportTaskEntity taskEntity) {
        ...
        if (reportEnum != null && RPTUserTypeEnum.SERVICE_POINT.equals(reportEnum.userType) && taskEntity.getTaskCreateBy() != null) {
            try {
    ...
    public MSResponse<String> getRptExcelDownloadUrl(@RequestBody RPTExportTaskEntity taskEntity) {
        ...
        try {
            RPTReportEnum reportEnum = RPTReportEnum.valueOf(taskEntity.getReportId());
            if (reportEnum != null && RPTUserTypeEnum.SERVICE_POINT.equals(reportEnum.userType)) {
